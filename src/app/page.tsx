...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-gradient-to-br from-white to-[#F5F5F5] food-pattern-bg overflow-hidden">
      <div className="flex-1 overflow-y-auto pt-6 px-4 md:px-8 pb-20">
        <h1 className="text-xl md:text-2xl font-bold text-center mb-4 text-[#333333]">
          Street Food <span className="text-[#FF5722]">Finder</span>
        </h1>

        <div className="max-w-md mx-auto md:max-w-2xl flex flex-col h-[calc(100vh-8rem)]">
          <PreferenceSelector />
